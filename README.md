...
- **Pre-provisioning certificates**: If you need to issue TLS certificates before the Lightsail host boots, see [`docs/certificate-strategies.md`](docs/certificate-strategies.md) for a comparison of DNS-01, Terraform-driven, and temporary-endpoint approaches plus their operational trade-offs.
